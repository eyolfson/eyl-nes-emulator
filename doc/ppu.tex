...
\indent CTRL WRITE: \hexadecimal{10}

\texttt{t} = \binary{XXXX 00XX XXXX XXXX}

STATUS READ: \hexadecimal{80}

\texttt{w} = \binary{0}

SCROLL WRITE: \hexadecimal{00}

\texttt{t} = \binary{XXXX 00XX XXX0 0000}
...
\texttt{t} = \binary{X000 0000 0000 0000}

\texttt{w} = \binary{0}

CTRL WRITE: \hexadecimal{90}

\texttt{t} = \binary{X000 0000 0000 0000}

VERTICAL BLANK

CTRL WRITE: \hexadecimal{10}

STATUS READ: \hexadecimal{C0}
